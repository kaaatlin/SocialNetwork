...
namespace SocialNetwork.BLL.Services
{
    public class UserService
    {
        ...
        public void AddFriend(UserAdditingngFriendData userAddingFriendData)
        {
        ...
        {
            var incomingMessages = messageService.GetIncomingMessages(userEntity.id);
            var outgoingMessages = messageService.GetOutcomingMessages(userEntity.id);
